		...
		<div class="modal-content">
			<form id="formNuevo">
				<div class="modal-header">
					...
					<h4 class="modal-title">Nuevo Productor</h4>
				</div>
	...
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content">
			<form id="formEditar">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title">Editar Productor</h4>
				</div>
				<div class="modal-body">
...
$(document).ready(function() {
    ...
    $('#formNuevo').submit(function(e) {
        ...
        $.ajax({
            url: 'modulo/productor.php?metodo=guardar',
            type : "POST",
            dataType : 'json',
            data : $(this).serialize()
        })
	...
	$('#mdlEditar').on('show.bs.modal', function (event) {
		...
		$.ajax({
            url: 'modulo/productor.php?metodo=obtener',
            type : "POST",
            dataType : 'json',
            data : {
            	id: id
    ...
    $('#formEditar').submit(function(e) {
        ...
        $.ajax({
            url: 'modulo/productor.php?metodo=editar',
            type : "POST",
            dataType : 'json',
            data : $(this).serialize()
        })
	...
	function getTable() {
	    return  $('#table')
				    .DataTable({
				        ...
				        "ajax":{
				            "method": "POST",
				            "url": "modulo/productor.php?metodo=listado",
				            "complete": function () {
				            	$('#table-body').show();
				            },
